...
|---|---|
| Run `tvplot run my-show/` or the HTML viewer locally | Your episode synopses, your analysis system choice, and your API key travel directly from your process (terminal or browser) to the LLM provider you picked |
...
1. **User-supplied** `.txt` synopses (CLI: `tvplot run my-show/`).
2. **Wikipedia/Fandom-scraped** raw episode descriptions rewritten into full synopses by the LLM (CLI: `tvplot write-synopses "Show Name"`).
