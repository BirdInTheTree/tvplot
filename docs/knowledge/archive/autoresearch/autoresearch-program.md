...
**What you CAN modify:**
- Prompt files: `src/tvplotlines/prompts/pass{0,1,2,3}.md` — role formulations, step structure, strictness criteria, examples, wording.
...
- Metric code: `src/tvplotlines/metrics.py` — the scoring function.
